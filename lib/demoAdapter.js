...
export function freshState() {
  return {
    ...
    // demo-link-2 starts with documents requested three days ago and nothing received yet.
    docRequests: { 'demo-link-2': { status: 'requested', url: 'https://rentletter.ca/upload/demo0000000000000000000000000002', requestedAt: new Date(Date.now() - 3 * 86400000).toISOString(), receivedAt: null } },
