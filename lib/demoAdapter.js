...
export function createDemoAdapter(initial) {
  ...
  const live = (listingId, apps) => { const l = state.listings.find((x) => x.id === listingId) || {}; return (apps || []).map((a) => { const s = withLiveScore(a, l); return { ...s, application: { ...s.application, fit: fitFor(s, l) } }; }); };
