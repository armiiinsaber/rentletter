...
// The name of the applicable provincial human-rights statute, for compliance/privacy copy.
// Both provinces' codes are officially the "Human Rights Code"; these are the standard
// province-qualified names. Unknown/default → Ontario (primary market).
export function humanRightsCodeName(v) {
  return normalizeProvince(v) === 'BC' ? 'British Columbia Human Rights Code' : 'Ontario Human Rights Code';
}
