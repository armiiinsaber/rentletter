...
export function readVerification(verification, { ignoreName = false } = {}) {
  ...
  if (!r || typeof r !== 'object' || docs.length === 0) return { state: 'none', incomeMatched: false, employerMatched: false, incomeFound: null, incomeMismatch: false, employerMismatch: false, employerAlsoSeen: [], employerSince: null };
  ...
  if (!ignoreName && (r.nameMatch === 'mismatch' || r.nameMatch === 'unclear')) return { state: r.nameMatch, incomeMatched: false, employerMatched: false, incomeFound: null, incomeMismatch: false, employerMismatch: false, employerAlsoSeen: [], employerSince: null };
