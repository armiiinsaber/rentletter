...
export function readVerification(verification, { ignoreName = false } = {}) {
  ...
  return { state: 'ok', incomeMatched: !!incomeM, employerMatched: !!employerM, incomeFound: incomeM ? (incomeM.annual != null ? Number(incomeM.annual) : parseMoney(incomeM.found || incomeM.stated)) : null, incomeExplanation: incomeRow ? (incomeRow.explanation || incomeRow.found || null) : null, incomeMismatch: !incomeM && differs(/income/i), employerMismatch: !employerM && differs(/employer/i) };
}
