...
import { compareFit, fitReason, parseYears, capOf, effectiveMinIncome } from './fitScore.js';
...
const pickConf = (c, who) => { const out = {}; for (const k of ['id', 'employer', 'landlord', 'landlord_reference', 'reference']) if (c && c[k] && typeof c[k] === 'object') out[k] = { at: c[k].at || null, by: c[k].by === 'You' || !c[k].by ? who : c[k].by }; return out; };
