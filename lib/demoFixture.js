...
const PLACEMENT = [
  ...
  { rl: 'RL-2026-5E6F-7081', listing: 'demo-carlaw', linkId: 'demo-link-5', reviewedAt: ago(2), docs: 'checked' },
...
export function buildDemoApplicants() {
  ...
  for (const p of PLACEMENT) {
    ...
    (out[p.listing] = out[p.listing] || []).push({
      ...
      confirmations: Object.fromEntries((p.confirm || []).map((k) => [k, { at: ago(2, 3), by: 'You' }])), lastSentAt: p.sent ? ago(typeof p.sent === 'number' ? p.sent : 1, 2) : null,
