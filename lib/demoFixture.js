...
export const DEMO_LISTINGS = [
  { id: 'demo-carlaw', profile_id: 'demo-realtor', name: '210 Carlaw Ave, Unit 4', address: '210 Carlaw Ave, Unit 4, Toronto', monthly_rent: 2600, bedrooms: '2', province: 'ON',
    ...
    pref_notes: 'Quiet building; landlord prefers a 12-month lease to start.', created_at: ago(18), status: 'active', closed_at: null, rented_link_id: null },
  { id: 'demo-harbour', profile_id: 'demo-realtor', name: '88 Harbour St, Unit 2104', address: '88 Harbour St, Unit 2104, Toronto', monthly_rent: 3100, bedrooms: '2', province: 'ON',
    ...
    pref_notes: null, created_at: ago(3), status: 'active', closed_at: null, rented_link_id: null },
];
...
export function demoPeopleSource() {
  ...
  const rented = { id: 'demo-rented', profile_id: 'demo-realtor', name: '15 Logan Ave, Unit 2', address: '15 Logan Ave, Unit 2, Toronto', status: 'rented', monthly_rent: 2400 };
