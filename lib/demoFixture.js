...
import { LEGACY_LISTING_STATUS, LISTING_STATE, applicationStateOf } from './application-state';
...
const SAMPLE_APPLICATIONS = [
  {
    ...
    move: { moveInDate: 'October 1, 2026' },
    household: { numberOfOccupants: '1', occupantsDetails: null, smoker: 'no' },
    coApplicant: null,
    lifestyle: { pets: 'One indoor cat, spayed, vet records available' },
  ...
  },
  {
    ...
    move: { moveInDate: 'September 15, 2026' },
  ...
  },
  {
    ...
    move: { moveInDate: 'November 1, 2026' },
  ...
  },
  {
    ...
    apartment: { address: '210 Carlaw Ave, Unit 4, Toronto', description: '2BR in Leslieville, $2,600/mo', estimatedRent: 2600, rentToIncomeRatio: 27 },
    move: { moveInDate: 'August 15, 2026' },
    ...
    lifestyle: { pets: 'One older dog, well trained' },
  ...
  },
  {
    ...
    move: { moveInDate: 'October 15, 2026' },
    household: { numberOfOccupants: '1', occupantsDetails: null, smoker: 'no' },
    coApplicant: null,
    lifestyle: { pets: null },
  ...
  },
  {
    ...
    move: { moveInDate: 'September 1, 2026' },
  ...
  {
    // A long name (the card header must hold it on one row) and an employer typed short: "Livenation"
    // against the letter's "Live Nation Canada Inc" (lib/documentAuthority.js normalizeEmployer).
    applicationNumber: 'RL-2026-9B8C-7D6E', createdAt: new Date(Date.now() - 86400000 * 1.5).toISOString(),
    email: 'alexandra.pw@email.com',
    tenant: { fullName: 'Alexandra Papadopoulos Whitfield', age: '36', dateOfBirth: '1990-01-15', phone: '(416) 555-0990' },
    employment: { jobTitle: 'Event Operations Manager', employer: 'Livenation', yearsAtJob: '4', annualIncome: 96000, monthlyIncome: 8000 },
    rental: { previousAddress: '12 Broadview Ave, Toronto', yearsAtPrevious: '3', previousLandlordName: 'Helen Park', previousLandlordContact: 'helen.park@email.com', currentRent: 2200 },
    apartment: { address: '210 Carlaw Ave, Unit 4, Toronto', description: '2BR in Leslieville, $2,600/mo', estimatedRent: 2600, rentToIncomeRatio: 33 },
    move: { moveInDate: 'October 15, 2026' },
    household: { numberOfOccupants: '1', occupantsDetails: null, smoker: 'no' },
    coApplicant: null,
    lifestyle: { pets: '' },
    vehicle: null,
    references: [{ name: 'Helen Park', relationship: 'Previous landlord (3 years)', contact: 'helen.park@email.com' }],
    disclosures: null,
    scorecard: null,
  },
];

// The realtor facing report in the shape lib/documentAuthority.js produces: the model extracts
// printed fields, the software resolves each fact from its strongest source. The credit report is
// read for its score only; its employer line (a previous employer) rides along as historical.
const SAMPLE_DOCINTEL = {
  analyzedAt: '2026-08-12T15:00:00Z',
  documentCount: 4,
  documents: [
    { filename: 'paystub-may.pdf', documentType: 'pay stub', extracted: { applicantName: 'Priya Sharma', employer: 'Sunnybrook Health Sciences Centre', periodStart: 'May 16, 2026', periodEnd: 'May 31, 2026', payDate: 'Jun 5, 2026', grossForPeriod: 3833.33, hours: 86.67, payFrequency: null, documentDate: 'Jun 5, 2026' }, notes: 'No frequency word printed.' },
    { filename: 'employment-letter.pdf', documentType: 'employment letter', extracted: { applicantName: 'Priya Sharma', employer: 'Sunnybrook Health Sciences Centre', employmentType: 'Full time, permanent', jobTitle: 'Registered Nurse', startDate: 'Sep 5, 2022', annualSalaryPrinted: 92000, documentDate: 'Jun 2, 2026' }, notes: 'Signed by HR.' },
    { filename: 'equifax-report.pdf', documentType: 'credit report', extracted: { applicantName: 'Priya Sharma', creditScore: 748, scoreBand: 'Very Good', bureau: 'Equifax', reportDate: 'Aug 1, 2026', employer: 'Lakeshore Family Practice' }, notes: 'Consumer credit report.' },
  ...
  crossReference: [
    { field: 'Applicant name', status: 'consistent', detail: 'Name matches across 4 documents.' },
    { field: 'Employer', status: 'consistent', detail: 'Employer matches across documents (Sunnybrook Health Sciences Centre).' },
  ],
  comparisons: [
    { field: 'Employer', stated: 'Sunnybrook Health Sciences Centre', found: 'Sunnybrook Health Sciences Centre', status: 'match', source: 'employment letter', alsoSeen: ['credit report lists Lakeshore Family Practice (historical)'], since: 'since Sep 2022', sinceGap: false, startDate: 'Sep 5, 2022' },
    { field: 'Job title', stated: 'Registered Nurse', found: 'Registered Nurse', status: 'match', source: 'employment letter', informational: true },
    { field: 'Income', stated: '$92,000', found: '$92,000 a year on the letter, pay stubs annualize to $92,000 (letter and pay stubs agree)', annual: 92000, basis: 'letter and pay stubs agree', explanation: '$92,000 a year on the letter, pay stubs annualize to $92,000 (letter and pay stubs agree)', confidence: 'high', stubs: { annual: 92000, explanation: '$3,833.33 semi monthly × 24 from 1 of 1 stub', basis: 'one full period' }, letter: { annual: 92000 }, status: 'match' },
  ],
  overallSummary: 'Read 4 documents. Employer, Job title, Income verified against the application. Document name matches the applicant.',
  confidence: 'high',
};

export const SAMPLE_DOCINTEL_SOURCE = 'realtor';

// Two more report shapes the sandbox must show. CHECKED: documents on file, the name matches,
// but nothing matched the application. MISMATCH: the name on the documents is someone else's.
export const SAMPLE_DOCINTEL_CHECKED = {
  ...SAMPLE_DOCINTEL, analyzedAt: ago(2), nameMatch: 'match',
  comparisons: [
    { field: 'Income', stated: '$78,000', found: '$61,500', status: 'close' },
    { field: 'Employer', stated: 'Northbridge Analytics', found: 'Northbridge Analytics Inc.', status: 'close' },
    { field: 'Job title', stated: 'Data Analyst', found: null, status: 'not_found' },
  ],
  overallSummary: 'The pay stub annualizes below the stated income and the employer name differs slightly; nothing on the documents matched the application exactly.',
  confidence: 'medium',
};
// Alexandra's report, as an earlier analysis stored it: the letter names "Live Nation Canada Inc",
// the application says "Livenation", and the stored Employer row says mismatch. The dashboard reads
// the employer status again through lib/documentAuthority.js normalizeEmployer (lib/fitScore.js
// readVerification), so the card reads docs match without a re analysis.
export const SAMPLE_DOCINTEL_LIVENATION = {
  analyzedAt: ago(1), documentCount: 2, nameMatch: 'match', source: 'tenant',
  documents: [
    { filename: 'employment-letter.pdf', documentType: 'employment letter', extracted: { applicantName: 'Alexandra Papadopoulos Whitfield', employer: 'Live Nation Canada Inc', employmentType: 'Full time, permanent', jobTitle: 'Event Operations Manager', startDate: 'Jun 1, 2022', annualSalaryPrinted: 96000, documentDate: 'Sep 2, 2026' }, notes: 'Signed by HR.' },
    { filename: 'paystub-august.pdf', documentType: 'pay stub', extracted: { applicantName: 'Alexandra Papadopoulos Whitfield', employer: 'Live Nation Canada Inc', periodStart: 'Aug 16, 2026', periodEnd: 'Aug 31, 2026', payDate: 'Sep 5, 2026', grossForPeriod: 4000, hours: 86.67, payFrequency: null, documentDate: 'Sep 5, 2026' }, notes: 'No frequency word printed.' },
  ],
  crossReference: [{ field: 'Applicant name', status: 'consistent', detail: 'Name matches across 2 documents.' }, { field: 'Employer', status: 'consistent', detail: 'Employer matches across documents (Live Nation Canada Inc).' }],
  comparisons: [
    { field: 'Employer', stated: 'Livenation', found: 'Live Nation Canada Inc', status: 'mismatch', source: 'employment letter', alsoSeen: [], since: 'since Jun 2022', sinceGap: false, startDate: 'Jun 1, 2022' },
    { field: 'Job title', stated: 'Event Operations Manager', found: 'Event Operations Manager', status: 'match', source: 'employment letter', informational: true },
    { field: 'Income', stated: '$96,000', found: '$96,000 a year on the letter, pay stubs annualize to $96,000 (letter and pay stubs agree)', annual: 96000, basis: 'letter and pay stubs agree', explanation: '$96,000 a year on the letter, pay stubs annualize to $96,000 (letter and pay stubs agree)', confidence: 'high', stubs: { annual: 96000, explanation: '$4,000.00 semi monthly × 24 from 1 of 1 stub', basis: 'one full period' }, letter: { annual: 96000 }, status: 'match' },
  ],
  overallSummary: 'Read 2 documents. Job title, Income verified against the application. Employer did not match the application, review the details. Document name matches the applicant.',
  confidence: 'high',
};
export const SAMPLE_DOCINTEL_MISMATCH = {
  ...SAMPLE_DOCINTEL, analyzedAt: ago(1), nameMatch: 'mismatch',
  comparisons: [],
  overallSummary: 'The name on the uploaded documents does not match the applicant. Nothing was compared.',
  confidence: 'low',
};

export { SAMPLE_DOCINTEL };
...
const UPGRADES = {
  ...
  'RL-2026-2B3C-4D5E': { employment: { employmentType: 'full-time', netIncome: 63900, netIncomeSource: 'stated' }, rental: { previousLandlordContact: 'anil.kapoor@email.com · 416-555-0222' } },
  ...
  'RL-2026-5E6F-7081': { employment: { employmentType: 'full-time', netIncome: 59700, netIncomeSource: 'estimated' }, rental: { previousLandlordContact: 'maria.santos@email.com · 416-555-0333' } },
  ...
  'RL-2026-9B8C-7D6E': { employment: { employmentType: 'full-time', netIncome: 70800, netIncomeSource: 'estimated' } },
...
export const DEMO_LISTINGS = [
  { id: 'demo-carlaw', profile_id: 'demo-realtor', name: '210 Carlaw Ave, Unit 4', address: '210 Carlaw Ave, Unit 4, Toronto', monthly_rent: 2600, bedrooms: '2', province: 'ON',
    ...
    pref_min_annual_income: 75000, pref_rent_to_income_max_pct: 40, pref_min_years_at_job: 1,
    pref_requires_landlord_reference: true, pref_requires_employer_verification: false,
    pref_notes: 'Quiet building; landlord prefers a 12-month lease to start.', created_at: ago(18), status: LEGACY_LISTING_STATUS.ACTIVE, state: LISTING_STATE.LIVE, closed_at: null, rented_link_id: null },
  { id: 'demo-harbour', profile_id: 'demo-realtor', name: '88 Harbour St, Unit 2104', address: '88 Harbour St, Unit 2104, Toronto', monthly_rent: 3100, bedrooms: '2', province: 'ON',
    ...
    pref_min_annual_income: 90000, pref_rent_to_income_max_pct: 35, pref_min_years_at_job: 2,
    pref_requires_landlord_reference: false, pref_requires_employer_verification: true,
    pref_notes: null, created_at: ago(3), status: LEGACY_LISTING_STATUS.ACTIVE, state: LISTING_STATE.LIVE, closed_at: null, rented_link_id: null },
];
...
//   confirm → the realtor's confirmations (verified state); sent → included in a sent report that many days ago (sent state)
//   docsBy 'tenant' → the held files came from the tenant; docsExpired → the held files were deleted by the 14 day expiry
const PLACEMENT = [
  { rl: 'RL-2026-1A2B-3C4D', listing: 'demo-carlaw', linkId: 'demo-link-1', reviewedAt: ago(6), docs: true, finalist: true, confirm: ['employer', 'landlord'] },
  { rl: 'RL-2026-2B3C-4D5E', listing: 'demo-carlaw', linkId: 'demo-link-2', reviewedAt: ago(6) },
  { rl: 'RL-2026-3C4D-5E6F', listing: 'demo-carlaw', linkId: 'demo-link-3', reviewedAt: ago(5), edited: true, docs: true, docsBy: 'tenant' },
  { rl: 'RL-2026-4D5E-6F70', listing: 'demo-carlaw', linkId: 'demo-link-4', reviewedAt: ago(5), decision: DECISION_STATUS.REJECT, reason: 'income_below_min' },
  { rl: 'RL-2026-5E6F-7081', listing: 'demo-carlaw', linkId: 'demo-link-5', reviewedAt: ago(2), docs: 'checked', confirm: ['landlord_reference'] }, // the previous landlord answered by email
  { rl: 'RL-2026-6F70-8192', listing: 'demo-carlaw', linkId: 'demo-link-6', reviewedAt: null },
  { rl: 'RL-2026-6F70-8193', listing: 'demo-carlaw', linkId: 'demo-link-9', reviewedAt: null }, // Sofia again: same phone, a work email (lib/duplicates.js)
  { rl: 'RL-2026-9B8C-7D6E', listing: 'demo-carlaw', linkId: 'demo-link-10', reviewedAt: ago(1), docs: 'livenation', docsBy: 'tenant' }, // the long name; Livenation against Live Nation Canada Inc
  { rl: 'RL-2026-7081-92A3', listing: 'demo-harbour', linkId: 'demo-link-7', reviewedAt: ago(1), docs: 'checked', sent: 6 },
  { rl: 'RL-2026-8192-A3B4', listing: 'demo-harbour', linkId: 'demo-link-8', reviewedAt: null, referred: true, docs: 'mismatch', docsExpired: true },
];

// The second application from the same person: Sofia Russo again, same phone, her work email.
SAMPLE_APPLICATIONS.push({ ...SAMPLE_APPLICATIONS.find((a) => a.applicationNumber === 'RL-2026-6F70-8192'), applicationNumber: 'RL-2026-6F70-8193', email: 's.russo@work.example', createdAt: new Date(Date.now() - 3600000 * 5).toISOString() });
...
// The files held for the realtor's review (db/documents.sql), one per document in the report.
// Uploaded 5 days ago, so the panel reads "Deleted in 9 days"; docsExpired rows read "expired".
function heldDocsFor(p, docs) {
  const report = docs[0];
  if (!report || !Array.isArray(report.documents)) return [];
  const up = ago(5, 2);
  return report.documents.map((d, i) => ({
    id: `demo-doc-${p.linkId.slice(-1)}-${i + 1}`, kind: d.documentType || 'unknown', mime: /\.pdf$/i.test(d.filename || '') ? 'application/pdf' : 'image/jpeg', bytes: 240000 + i * 31000,
    uploadedBy: p.docsBy === 'tenant' ? 'tenant' : 'realtor', uploadedAt: up, expiresAt: expiryFor(up),
    deletedAt: p.docsExpired ? ago(0, 5) : null, deletedBy: p.docsExpired ? 'expired' : null, openedCount: 0, lastOpenedAt: null,
  }));
}
...
export function buildDemoApplicants() {
  ...
  for (const p of PLACEMENT) {
    ...
    const docs = p.docs === 'livenation' ? [{ ...SAMPLE_DOCINTEL_LIVENATION }]
      : p.docs === 'checked' ? [{ ...SAMPLE_DOCINTEL_CHECKED, source: 'realtor' }]
      : p.docs === 'mismatch' ? [{ ...SAMPLE_DOCINTEL_MISMATCH, source: 'realtor' }]
      : p.docs ? [{ ...SAMPLE_DOCINTEL, analyzedAt: p.edited ? ago(4) : SAMPLE_DOCINTEL.analyzedAt, source: 'realtor' }] : [];
    (out[p.listing] = out[p.listing] || []).push({
      // The state the row carries in production, from the same old columns (db/003 mapping).
      state: applicationStateOf({ decisionStatus: p.decision || DECISION_STATUS.NONE, decisionPriority: p.finalist ? DECISION_PRIORITY.TOP : DECISION_PRIORITY.NORMAL }),
      ...
      confirmations: Object.fromEntries((p.confirm || []).map((k) => [k, { at: ago(2, 3), by: k === 'landlord_reference' ? 'reference' : 'You' }])), lastSentAt: p.sent ? ago(typeof p.sent === 'number' ? p.sent : 1, 2) : null,
      application: row, docVerifications: docs, docArchived: [], storedDocuments: heldDocsFor(p, docs),
    });
  }
  return out;
}
...
// Pipeline (lib/pipelineState.js peopleRows): four consent rows for the sandbox, none of them on
// a live listing. Tomas Reyes was asked yesterday and has not answered (pending). Nadia Petrov lost a rented unit and carries a landlord confirmation (4.1 against
// Carlaw: with the documents gone and no employer confirmation, 4.1 is the ceiling); Daniel Osei
// scores 3.1; one email only from a rented link. Nadia is already invited to Harbour.
export function demoPeopleSource() {
  const nadia = { id: 'demo-app-p-1', application_number: 'RL-2026-9A1B-2C3D', email: 'nadia.petrov@email.com', full_name: 'Nadia Petrov', phone: '(416) 555-0921', date_of_birth: '1992-05-03',
    job_title: 'Pharmacist', employer: 'Shoppers Drug Mart', years_at_job: '5', annual_income: 112000, employment_type: 'full-time', net_income: 79000, net_income_source: 'estimated',
    prev_address: '31 Pape Ave, Toronto', years_at_previous: '3', prev_landlord_name: 'Ruth Adler', prev_landlord_contact: 'ruth.adler@email.com · 416-555-0188', current_rent: 2150,
    move_in_date: '2026-11-01', pets: '', co_applicant: null, scorecard: { ageConfirmed: true }, references: [{ name: 'Ruth Adler', relationship: 'Previous landlord (3 years)', contact: '416-555-0188' }, { name: 'Sam Iyer', relationship: 'Pharmacy manager', contact: 's.iyer@email.com' }], created_at: ago(20) };
  const daniel = { id: 'demo-app-p-2', application_number: 'RL-2026-8B2C-3D4E', email: 'daniel.osei@email.com', full_name: 'Daniel Osei', phone: '(647) 555-0377', date_of_birth: '1996-10-19',
    job_title: 'Account Coordinator', employer: 'Klick Health', years_at_job: '0.5', annual_income: 82000, employment_type: 'full-time', net_income: 60000, net_income_source: 'estimated',
    prev_address: '9 Coxwell Ave, Toronto', years_at_previous: '', prev_landlord_name: null, prev_landlord_contact: null, current_rent: 1800,
    move_in_date: '2026-10-15', pets: '', co_applicant: null, scorecard: { ageConfirmed: true }, references: [], created_at: ago(19) };
  const tomas = { id: 'demo-app-p-3', application_number: 'RL-2026-7C3D-4E5F', email: 'tomas.reyes@email.com', full_name: 'Tomas Reyes', phone: '(416) 555-0462', date_of_birth: '1994-02-11',
    job_title: 'Electrician', employer: 'Plan Group', years_at_job: '6', annual_income: 96000, employment_type: 'full-time', net_income: 70000, net_income_source: 'estimated',
    prev_address: '77 Danforth Ave, Toronto', years_at_previous: '2', prev_landlord_name: 'Ken Ma', prev_landlord_contact: '416-555-0290', current_rent: 2000,
    move_in_date: '2026-11-01', pets: '', co_applicant: null, scorecard: { ageConfirmed: true }, references: [{ name: 'Ken Ma', relationship: 'Previous landlord', contact: '416-555-0290' }], created_at: ago(18) };
  const consents = [
    { id: 'demo-consent-1', profile_id: 'demo-realtor', listing_id: 'demo-rented', application_id: nadia.id, email: nadia.email, status: 'consented', consented_at: ago(9), expires_at: new Date(Date.now() + 51 * 86400000).toISOString(), invites: [{ listingId: 'demo-harbour', at: ago(2) }] },
    { id: 'demo-consent-2', profile_id: 'demo-realtor', listing_id: 'demo-rented', application_id: daniel.id, email: daniel.email, status: 'consented', consented_at: ago(8), expires_at: new Date(Date.now() + 52 * 86400000).toISOString(), invites: [] },
    { id: 'demo-consent-3', profile_id: 'demo-realtor', listing_id: 'demo-rented', application_id: null, email: 'jordan.lee@example.com', status: 'consented', consented_at: ago(3), expires_at: new Date(Date.now() + 57 * 86400000).toISOString(), invites: [] },
    { id: 'demo-consent-4', profile_id: 'demo-realtor', listing_id: 'demo-rented', application_id: tomas.id, email: tomas.email, status: 'pending', consented_at: null, created_at: ago(1), expires_at: new Date(Date.now() + 59 * 86400000).toISOString(), invites: [] },
  ];
  const junctions = [{ id: 'demo-link-p-1', listing_id: 'demo-rented', application_id: nadia.id, confirmations: { landlord: { at: ago(12), by: 'You' } } }, { id: 'demo-link-p-2', listing_id: 'demo-rented', application_id: daniel.id, confirmations: {} }, { id: 'demo-link-p-3', listing_id: 'demo-rented', application_id: tomas.id, confirmations: {} }];
  const rented = { id: 'demo-rented', profile_id: 'demo-realtor', name: '15 Logan Ave, Unit 2', address: '15 Logan Ave, Unit 2, Toronto', status: LEGACY_LISTING_STATUS.RENTED, state: LISTING_STATE.RENTED, monthly_rent: 2400 };
  return { consents, applications: [nadia, daniel, tomas], junctions, rented };
}
// The prefilled apply page in the sandbox (?from=demoprefill): Nadia's application as a form.
export function demoPrefillRow() { return demoPeopleSource().applications[0]; }
...
export function referredApplicationForAssign() {
  const app = upgraded({
    ...
    move: { moveInDate: 'November 1, 2026' },
    household: { numberOfOccupants: '1', occupantsDetails: null, smoker: 'no', evParkingNeeded: null }, coApplicant: null,
    lifestyle: { pets: '' }, vehicle: null,
