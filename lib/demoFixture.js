...
export function buildDemoApplicants() {
  ...
  for (const p of PLACEMENT) {
    ...
    (out[p.listing] = out[p.listing] || []).push({
      ...
      application: row, docVerifications: docs, docArchived: [], aiInsight: p.docs && !p.edited ? SAMPLE_INSIGHT : null, storedDocuments: heldDocsFor(p, docs),
    });
  }
  return out;
}
...
export function demoPeopleSource() {
  const nadia = { id: 'demo-app-p-1', application_number: 'RL-2026-9A1B-2C3D', email: 'nadia.petrov@email.com', full_name: 'Nadia Petrov', phone: '(416) 555-0921', date_of_birth: '1992-05-03',
    ...
    move_in_date: '2026-11-01', pets: '', co_applicant: null, references: [{ name: 'Ruth Adler', relationship: 'Previous landlord (3 years)', contact: '416-555-0188' }, { name: 'Sam Iyer', relationship: 'Pharmacy manager', contact: 's.iyer@email.com' }], created_at: ago(20) };
  const daniel = { id: 'demo-app-p-2', application_number: 'RL-2026-8B2C-3D4E', email: 'daniel.osei@email.com', full_name: 'Daniel Osei', phone: '(647) 555-0377', date_of_birth: '1996-10-19',
    ...
    move_in_date: '2026-10-15', pets: '', co_applicant: null, references: [], created_at: ago(19) };
  const consents = [
