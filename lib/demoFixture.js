...
// People (lib/pipelineState.js peopleRows): three consent rows for the sandbox, none of them on
// a live listing. Nadia Petrov lost a rented unit and carries a landlord confirmation (4.1 against
...
export function demoPeopleSource() {
  ...
  const junctions = [{ id: 'demo-link-p-1', listing_id: 'demo-rented', application_id: nadia.id, confirmations: { landlord: { at: ago(12), by: 'You' } } }, { id: 'demo-link-p-2', listing_id: 'demo-rented', application_id: daniel.id, confirmations: {} }];
  ...
  return { consents, applications: [nadia, daniel], junctions, rented };
}
