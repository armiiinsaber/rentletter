...
export function kvAppToRow(app) {
  ...
  return {
    ...
    // check keeps only its answer, scorecard.ageConfirmed (the read side loads scorecard jsonb).
    phone: t.phone || null,
    // employment
    ...
    scorecard: app.scorecard || t.ageConfirmed ? { ...(app.scorecard || {}), ageConfirmed: t.ageConfirmed === true } : null,
...
export const OPTIONAL_COLUMNS = ['profile_updated_at', 'profile_revision', 'employment_type', 'business_name', 'net_income', 'net_income_source', 'referral_meta'];
