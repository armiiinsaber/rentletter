...
// Fit first; an applicant without a Fit (no rent share) sorts after every scored one.
const fitScore = (a) => (a.application?.fit?.score != null ? a.application.fit.score : -1);
