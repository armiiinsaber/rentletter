...
export async function recordForListing(admin, listingId, type, { applicationId = null, linkId = null, payload = {} } = {}) {
  try {
    ...
    return recordEvent(admin, { profileId: listing.profile_id, listingId: listing.id, applicationId, type, payload: { ...payload, listingName: displayLabel(listing) || listing.address || null, applicantName, linkId } });
  } catch (e) {
