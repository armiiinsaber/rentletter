...
export const STATE_LABELS = Object.freeze({
  ...
  // Where the applicant stands on the listing, not what their documents say (lib/applicantState.js
  // processState). The checklist's documents fact and the report's reason line follow the
  // documents and the Fit, and the Next list lists document work only, so those stay null.
  not_selected: Object.freeze({ title: null, line: 'Not selected', count: 'not selected', docs: null, reason: null }),
  reconsidered: Object.freeze({ title: null, line: 'Reconsidered · {reason}', count: 'reconsidered', docs: null, reason: null }),
});
