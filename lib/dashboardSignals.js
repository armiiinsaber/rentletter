...
async function loadSignalsInner({ supabase, admin, user, listings }) {
  ...
  return JSON.parse(JSON.stringify({
    listings: all.map((l) => ({ id: l.id, name: l.name, address: l.address, monthly_rent: l.monthly_rent, bedrooms: l.bedrooms ?? null, created_at: l.created_at || null, landlord_email: l.landlord_email, landlord_name: l.landlord_name, status: l.status || 'active', closed_at: l.closed_at || null, rented_link_id: l.rented_link_id || null })),
