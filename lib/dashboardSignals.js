...
import { carriedListingColumns } from './application-state.js';
...
async function loadSignalsInner({ supabase, admin, user, listings }) {
  ...
  return JSON.parse(JSON.stringify({
    listings: all.map((l) => ({ id: l.id, name: l.name, address: l.address, unit: l.unit ?? null, monthly_rent: l.monthly_rent, bedrooms: l.bedrooms ?? null, created_at: l.created_at || null, landlord_email: l.landlord_email, landlord_name: l.landlord_name, ...carriedListingColumns(l) })),
