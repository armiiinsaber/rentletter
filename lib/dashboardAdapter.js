...
export const DASHBOARD_ROUTES = [
  ...
  'POST /api/applicants/verify-confirm-pdf', 'POST /api/applicants/verify-confirm-text',
  'GET /api/assistant/signals', 'GET /api/events', 'POST /api/events/read', 'POST /api/events/record',
];
