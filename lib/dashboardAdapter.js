...
export const DASHBOARD_ROUTES = [
  'GET /api/pipeline/people', 'POST /api/pipeline/invite', 'POST /api/pipeline/remove', 'POST /api/references/request',
  'GET /api/notifications', 'POST /api/notifications',
  'GET /api/referrals/inbox', 'GET /api/referrals/list', 'POST /api/referrals/assign', 'POST /api/referrals/create', 'POST /api/referrals/claim',
  'GET /api/listings/applicants', 'POST /api/listings/invite', 'POST /api/listings/status', 'POST /api/listings/add-applicant',
  'POST /api/listings/create', 'POST /api/listings/update', 'POST /api/listings/delete',
  'POST /api/applicants/decision', 'POST /api/applicants/withdraw', 'POST /api/applicants/reconsider', 'POST /api/applicants/reviewed',
  'POST /api/profile/branding', 'POST /api/profile/update',
  ...
  'POST /api/applicants/analyze-file', 'POST /api/applicants/finalize-analysis', 'POST /api/applicants/manage-analysis',
  ...
  'GET /api/assistant/signals', 'GET /api/assistant/dismiss', 'POST /api/assistant/dismiss', 'GET /api/events', 'POST /api/events/read',
];
// Supabase tables the dashboard READS from the browser (RLS scoped in the real app). Every write
// goes through a route above; components and pages never call insert, update, upsert, delete
// or rpc on a Supabase client (tests/realtorWrites.test.mjs asserts it).
...
export const realPaths = { home: '/dashboard', listing: (id) => `/listing/${id}`, profile: '/profile', signin: '/signin' };
