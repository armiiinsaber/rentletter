...
export async function buildVerificationPdf({ profile, listing, applicantName, verification, fonts }) {
  ...
  page.drawText('Self-reported data - verify references independently. Screening must comply with the Ontario Human Rights Code.', { x: MARGIN, y: 44, size: 8, font: bodyFont, color: INK_MUTE });
