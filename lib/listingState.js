...
// The message, in the realtor's voice, neutral: no winner, no score, no reason.
// Both links open /keep/{token}; the answer is a tap on that page, never a page load (scanners
// open every link in an email).
export function notSelectedEmail({ listingName, realtorName, keepUrl }) {
