...
// scorecard against THAT listing, mirror, link (added_via 'referral'). One listing per referral.
export async function assignReferral(ref, listing, user) {
  ...
  await linkApplicantToListing(a, listing.id, applicationId, 'referral');
