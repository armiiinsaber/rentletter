...
export async function deleteListing(deps, body) {
  ...
  await recordEvent(admin, { profileId: userId, listingId: null, type: 'listing_updated', payload: { status: 'deleted', listingName: displayLabel(own) || own.address || null, listingId: own.id } });
