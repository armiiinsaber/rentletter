...
</html>`)})}catch(a){return console.error("Magic link email failed:",a),b.status(500).json({error:"Could not send sign-in email."})}return b.status(200).json({ok:!0})}d()}catch(a){d(a)}})}};var b=require("../../../webpack-api-runtime.js");b.C(a);var c=b.X(0,[7169],()=>b(b.s=6778));module.exports=c})();