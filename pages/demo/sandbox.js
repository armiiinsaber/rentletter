// pages/demo/sandbox.js — the public product demo.
...
export default function DemoSandbox() {
  ...
  useEffect(() => { if (view?.missing) router.replace('/demo/sandbox'); }, [view, router]);

  const reset = () => { adapter.reset(); window.location.href = '/demo/sandbox'; };
