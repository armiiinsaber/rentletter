...
export default async function handler(req, res) {
  ...
  const { applications, decisions, options } = req.body || {};
  ...
  try {
    ...
    cover.drawText('rentletter.ca · Toronto · Free for landlords + realtors', { x: 48, y: 46, size: 9, font: helv, color: INK_MUTE });
