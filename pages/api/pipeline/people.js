...
// requireRealtor; the list reads only consent rows with this profile_id.
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const people = await listPeople({ profileId: ctx.user.id, listings: listings || [], admin: ctx.admin });
