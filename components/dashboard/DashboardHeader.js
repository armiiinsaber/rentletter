  ...
  return (
    <ScrollHeader maxWidth={1100}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexWrap: 'wrap', justifyContent: 'flex-end' }}>
        ...
        {/* Obvious profile/branding entry point — avatar (logo or initials) + name. */}
        <button onClick={onEditProfile} className="rl-btn" title="Your profile & branding"
          aria-label="Open your profile and branding"
          style={{ display: 'inline-flex', alignItems: 'center', gap: 9, padding: '4px 12px 4px 4px', borderRadius: R.pill, background: C.card, border: `1px solid ${C.ruleDark}`, cursor: 'pointer' }}>
