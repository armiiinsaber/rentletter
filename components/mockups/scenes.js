  ...
  return (
    <div style={{ position: 'absolute', inset: 0, background: C.paper, overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
      <div style={{ padding: '10px 14px', borderBottom: `1px solid ${C.rule}`, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        <span style={{ display: 'inline-flex', alignItems: 'center', gap: 8 }}><span style={{ fontSize: 8.5, fontWeight: 800, color: C.green, background: C.greenTint, padding: '2px 7px', borderRadius: 999, letterSpacing: '0.06em' }}>FOUNDER</span><span style={{ position: 'relative', display: 'inline-flex' }}><Icon name="bell" size={15} color={C.ink} /><span style={{ position: 'absolute', top: -2, right: -2, width: 7, height: 7, borderRadius: '50%', background: C.red }} /></span></span>
      </div>
